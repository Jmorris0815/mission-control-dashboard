    ...
    <>
      <header className="h-14 border-b border-[#2A2A2A] bg-[#1A1A1A] flex items-center px-4 gap-4 flex-shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 bg-[#E8A838] hover:bg-[#E8A838]/90 text-black font-semibold text-sm rounded-lg transition-all shadow-lg shadow-[#E8A838]/20"
          title="Dispatch Task (⌘D)"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
